...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldChar3 : ICoherenceComponentData
    {
        [StructLayout(LayoutKind.Explicit)]
        public struct Interop
        {
            [FieldOffset(0)]
            public System.Char number;
        }

        public void ResetFrame(AbsoluteSimulationFrame frame)
        {
            FieldsMask |= GenericFieldChar3.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldChar3 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 136");
            }
            ...
            var orig = new GenericFieldChar3();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldChar3.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldChar3)data;
        ...
        public static uint Serialize(GenericFieldChar3 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                bitStream.WriteChar(fieldValue);
            }
        ...
        public static GenericFieldChar3 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldChar3();
            if (bitStream.ReadMask())
            {
                val.numberSimulationFrame = referenceSimulationFrame + DeserializerTools.ReadFieldSimFrameDelta(bitStream);

                val.number = bitStream.ReadChar();
                val.FieldsMask |= GenericFieldChar3.numberMask;
            }
