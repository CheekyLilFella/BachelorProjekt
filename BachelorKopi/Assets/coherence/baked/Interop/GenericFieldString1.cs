...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldString1 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldString1.nameMask;
            nameSimulationFrame = frame;
        }

        public static unsafe GenericFieldString1 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 16) " +
                    "for component with ID 77");
            }
            ...
            var orig = new GenericFieldString1();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldString1.nameMask) != 0 && (min == null || this.nameSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldString1 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldString1 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldString1.nameMask;
            }
