...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldDouble8 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldDouble8.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldDouble8 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
            ...
            var orig = new GenericFieldDouble8();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldDouble8.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldDouble8)data;
        ...
        public static uint Serialize(GenericFieldDouble8 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldDouble8 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldDouble8();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldDouble8.numberMask;
            }
