...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldDouble1 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldDouble1.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldDouble1 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
            ...
            var orig = new GenericFieldDouble1();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldDouble1.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldDouble1)data;
        ...
        public static uint Serialize(GenericFieldDouble1 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldDouble1 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldDouble1();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldDouble1.numberMask;
            }
