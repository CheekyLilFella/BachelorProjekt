...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldSByte0 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldSByte0.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldSByte0 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 103");
            }
            ...
            var orig = new GenericFieldSByte0();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldSByte0.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldSByte0)data;
        ...
        public static uint Serialize(GenericFieldSByte0 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldSByte0 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldSByte0();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldSByte0.numberMask;
            }
