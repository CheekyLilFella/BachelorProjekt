...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldDouble2 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldDouble2.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldDouble2 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
            ...
            var orig = new GenericFieldDouble2();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldDouble2.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldDouble2)data;
        ...
        public static uint Serialize(GenericFieldDouble2 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldDouble2 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldDouble2();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldDouble2.numberMask;
            }
