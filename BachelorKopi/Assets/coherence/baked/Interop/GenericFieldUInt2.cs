...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUInt2 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUInt2.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUInt2 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
            ...
            var orig = new GenericFieldUInt2();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUInt2.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldUInt2 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.number, _number_Min, _number_Max, "GenericFieldUInt2.number", logger);
        ...
        public static GenericFieldUInt2 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUInt2.numberMask;
            }
