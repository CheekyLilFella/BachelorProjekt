...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldFloat2 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldFloat2.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldFloat2 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
            ...
            var orig = new GenericFieldFloat2();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldFloat2.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        public static GenericFieldFloat2 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldFloat2.numberMask;
            }
