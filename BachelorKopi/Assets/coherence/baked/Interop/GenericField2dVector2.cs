...
namespace Coherence.Generated
{
    ...
    public struct GenericField2dVector2 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericField2dVector2.valueMask;
            valueSimulationFrame = frame;
        }

        public static unsafe GenericField2dVector2 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 8) " +
                    "for component with ID 74");
            }
            ...
            var orig = new GenericField2dVector2();
        ...
        public static uint Serialize(GenericField2dVector2 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericField2dVector2 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
