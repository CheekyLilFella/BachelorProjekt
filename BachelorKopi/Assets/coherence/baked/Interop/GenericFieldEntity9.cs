...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity9 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldEntity9.valueMask;
            valueSimulationFrame = frame;
        }

        public static unsafe GenericFieldEntity9 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 91");
            }
            ...
            var orig = new GenericFieldEntity9();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldEntity9.valueMask) != 0 && (min == null || this.valueSimulationFrame < min))
            {
        ...
        public static GenericFieldEntity9 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldEntity9.valueMask;
            }
