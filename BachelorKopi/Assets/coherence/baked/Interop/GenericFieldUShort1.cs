...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUShort1 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUShort1.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUShort1 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 124");
            }
            ...
            var orig = new GenericFieldUShort1();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUShort1.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldUShort1)data;
        ...
        public static uint Serialize(GenericFieldUShort1 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldUShort1 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldUShort1();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUShort1.numberMask;
            }
