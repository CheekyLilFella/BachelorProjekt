...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldQuaternion0 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldQuaternion0.valueMask;
            valueSimulationFrame = frame;
        }

        public static unsafe GenericFieldQuaternion0 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 16) " +
                    "for component with ID 81");
            }
            ...
            var orig = new GenericFieldQuaternion0();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldQuaternion0.valueMask) != 0 && (min == null || this.valueSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldQuaternion0 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldQuaternion0 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldQuaternion0.valueMask;
            }
        ...
        {
            return $"GenericFieldQuaternion0(" +
                $" value: { this.value }" +
