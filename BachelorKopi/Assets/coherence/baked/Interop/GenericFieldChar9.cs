...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldChar9 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldChar9.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldChar9 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 142");
            }
            ...
            var orig = new GenericFieldChar9();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldChar9.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldChar9)data;
        ...
        public static uint Serialize(GenericFieldChar9 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldChar9 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldChar9.numberMask;
            }
