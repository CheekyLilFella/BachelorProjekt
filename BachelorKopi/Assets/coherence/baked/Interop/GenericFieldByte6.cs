...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldByte6 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldByte6.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldByte6 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 99");
            }
            ...
            var orig = new GenericFieldByte6();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldByte6.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldByte6)data;
        ...
        public static uint Serialize(GenericFieldByte6 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldByte6 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldByte6.numberMask;
            }
