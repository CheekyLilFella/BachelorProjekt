...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldLong1 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldLong1.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldLong1 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 8) " +
                    "for component with ID 144");
            }
            ...
            var orig = new GenericFieldLong1();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldLong1.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldLong1 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldLong1 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldLong1.numberMask;
            }
