...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldByte8 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldByte8.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldByte8 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 101");
            }
            ...
            var orig = new GenericFieldByte8();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldByte8.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldByte8)data;
        ...
        public static uint Serialize(GenericFieldByte8 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldByte8 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldByte8.numberMask;
            }
