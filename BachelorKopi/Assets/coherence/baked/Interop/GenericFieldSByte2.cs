...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldSByte2 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldSByte2.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldSByte2 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 105");
            }
            ...
            var orig = new GenericFieldSByte2();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldSByte2.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldSByte2)data;
        ...
        public static uint Serialize(GenericFieldSByte2 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldSByte2 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldSByte2();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldSByte2.numberMask;
            }
