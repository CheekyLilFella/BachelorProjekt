...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldShort9 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldShort9.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldShort9 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 122");
            }
            ...
            var orig = new GenericFieldShort9();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldShort9.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldShort9)data;
        ...
        public static uint Serialize(GenericFieldShort9 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldShort9 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldShort9();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldShort9.numberMask;
            }
