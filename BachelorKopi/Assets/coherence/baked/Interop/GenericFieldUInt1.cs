...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUInt1 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUInt1.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUInt1 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
            ...
            var orig = new GenericFieldUInt1();
        ...
        public static uint Serialize(GenericFieldUInt1 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.number, _number_Min, _number_Max, "GenericFieldUInt1.number", logger);
        ...
        public static GenericFieldUInt1 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
