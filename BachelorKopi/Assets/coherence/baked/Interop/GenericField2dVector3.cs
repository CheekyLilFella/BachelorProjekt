...
namespace Coherence.Generated
{
    ...
    public struct GenericField2dVector3 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericField2dVector3.valueMask;
            valueSimulationFrame = frame;
        }

        public static unsafe GenericField2dVector3 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 8) " +
                    "for component with ID 75");
            }
            ...
            var orig = new GenericField2dVector3();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericField2dVector3.valueMask) != 0 && (min == null || this.valueSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericField2dVector3 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericField2dVector3 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericField2dVector3.valueMask;
            }
