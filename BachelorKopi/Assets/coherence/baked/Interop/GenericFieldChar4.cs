...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldChar4 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldChar4.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldChar4 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 137");
            }
            ...
            var orig = new GenericFieldChar4();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldChar4.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldChar4)data;
        ...
        public static uint Serialize(GenericFieldChar4 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldChar4 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldChar4.numberMask;
            }
