...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldByte7 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldByte7.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldByte7 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 100");
            }
            ...
            var orig = new GenericFieldByte7();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldByte7.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldByte7)data;
        ...
        public static uint Serialize(GenericFieldByte7 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldByte7 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldByte7();
            if (bitStream.ReadMask())
            {
                val.numberSimulationFrame = referenceSimulationFrame + DeserializerTools.ReadFieldSimFrameDelta(bitStream);

                val.number = bitStream.ReadByte();
                val.FieldsMask |= GenericFieldByte7.numberMask;
            }
