...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldDouble0 : ICoherenceComponentData
    {
        ...
        public static unsafe GenericFieldDouble0 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            ...
            var orig = new GenericFieldDouble0();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldDouble0.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldDouble0)data;
        ...
        public static uint Serialize(GenericFieldDouble0 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldDouble0 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldDouble0();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldDouble0.numberMask;
            }
