...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldSByte9 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldSByte9.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldSByte9 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 112");
            }
            ...
            var orig = new GenericFieldSByte9();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldSByte9.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldSByte9)data;
        ...
        public static uint Serialize(GenericFieldSByte9 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldSByte9 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldSByte9();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldSByte9.numberMask;
            }
