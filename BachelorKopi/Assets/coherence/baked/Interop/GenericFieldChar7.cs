...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldChar7 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldChar7.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldChar7 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 140");
            }
            ...
            var orig = new GenericFieldChar7();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldChar7.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldChar7)data;
        ...
        public static uint Serialize(GenericFieldChar7 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldChar7 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldChar7.numberMask;
            }
