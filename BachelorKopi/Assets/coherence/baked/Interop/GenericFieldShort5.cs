...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldShort5 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldShort5.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldShort5 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 118");
            }
            ...
            var orig = new GenericFieldShort5();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldShort5.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldShort5)data;
        ...
        public static uint Serialize(GenericFieldShort5 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldShort5 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldShort5();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldShort5.numberMask;
            }
