...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity4 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldEntity4.valueMask;
            valueSimulationFrame = frame;
        }

        public static unsafe GenericFieldEntity4 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 86");
            }
            ...
            var orig = new GenericFieldEntity4();
        ...
        public static uint Serialize(GenericFieldEntity4 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldEntity4 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
