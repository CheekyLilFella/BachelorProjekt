...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUShort3 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUShort3.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUShort3 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 126");
            }
            ...
            var orig = new GenericFieldUShort3();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUShort3.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldUShort3)data;
        ...
        public static uint Serialize(GenericFieldUShort3 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldUShort3 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldUShort3();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUShort3.numberMask;
            }
