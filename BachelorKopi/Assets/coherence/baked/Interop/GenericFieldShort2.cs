...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldShort2 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldShort2.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldShort2 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 115");
            }
            ...
            var orig = new GenericFieldShort2();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldShort2.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldShort2)data;
        ...
        public static uint Serialize(GenericFieldShort2 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldShort2 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldShort2();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldShort2.numberMask;
            }
