...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldSByte1 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldSByte1.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldSByte1 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 104");
            }
            ...
            var orig = new GenericFieldSByte1();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldSByte1.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldSByte1)data;
        ...
        public static uint Serialize(GenericFieldSByte1 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldSByte1 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldSByte1();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldSByte1.numberMask;
            }
