...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUInt8 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUInt8.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUInt8 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
            ...
            var orig = new GenericFieldUInt8();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUInt8.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldUInt8 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.number, _number_Min, _number_Max, "GenericFieldUInt8.number", logger);
        ...
        public static GenericFieldUInt8 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUInt8.numberMask;
            }
