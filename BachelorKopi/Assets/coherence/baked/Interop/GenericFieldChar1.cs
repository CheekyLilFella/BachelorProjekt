...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldChar1 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldChar1.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldChar1 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 134");
            }
            ...
            var orig = new GenericFieldChar1();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldChar1.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldChar1)data;
        ...
        public static uint Serialize(GenericFieldChar1 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldChar1 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldChar1.numberMask;
            }
