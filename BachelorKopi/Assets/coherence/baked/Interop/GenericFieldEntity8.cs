...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity8 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldEntity8.valueMask;
            valueSimulationFrame = frame;
        }

        public static unsafe GenericFieldEntity8 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 90");
            }
            ...
            var orig = new GenericFieldEntity8();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldEntity8.valueMask) != 0 && (min == null || this.valueSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldEntity8 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldEntity8 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldEntity8.valueMask;
            }
