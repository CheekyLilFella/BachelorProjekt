...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldDouble4 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldDouble4.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldDouble4 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
            ...
            var orig = new GenericFieldDouble4();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldDouble4.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldDouble4)data;
        ...
        public static uint Serialize(GenericFieldDouble4 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldDouble4 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldDouble4();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldDouble4.numberMask;
            }
