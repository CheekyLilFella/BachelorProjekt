...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldByte3 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldByte3.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldByte3 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 96");
            }
            ...
            var orig = new GenericFieldByte3();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldByte3.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldByte3)data;
        ...
        public static uint Serialize(GenericFieldByte3 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldByte3 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldByte3.numberMask;
            }
