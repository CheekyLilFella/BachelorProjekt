...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldChar0 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldChar0.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldChar0 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 133");
            }
            ...
            var orig = new GenericFieldChar0();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldChar0.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldChar0)data;
        ...
        public static uint Serialize(GenericFieldChar0 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldChar0 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldChar0.numberMask;
            }
