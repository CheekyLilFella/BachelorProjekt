...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldString2 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldString2.nameMask;
            nameSimulationFrame = frame;
        }

        public static unsafe GenericFieldString2 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 16) " +
                    "for component with ID 78");
            }
            ...
            var orig = new GenericFieldString2();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldString2.nameMask) != 0 && (min == null || this.nameSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldString2 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldString2 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldString2.nameMask;
            }
