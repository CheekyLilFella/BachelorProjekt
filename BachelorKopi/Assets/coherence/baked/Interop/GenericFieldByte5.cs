...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldByte5 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldByte5.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldByte5 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 98");
            }
            ...
            var orig = new GenericFieldByte5();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldByte5.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldByte5)data;
        ...
        public static uint Serialize(GenericFieldByte5 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldByte5 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldByte5.numberMask;
            }
