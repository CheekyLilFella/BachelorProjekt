...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldSByte3 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldSByte3.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldSByte3 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 106");
            }
            ...
            var orig = new GenericFieldSByte3();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldSByte3.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldSByte3)data;
        ...
        public static uint Serialize(GenericFieldSByte3 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldSByte3 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldSByte3();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldSByte3.numberMask;
            }
