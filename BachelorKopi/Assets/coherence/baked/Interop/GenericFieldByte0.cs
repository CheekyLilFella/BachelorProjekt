...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldByte0 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldByte0.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldByte0 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 93");
            }
            ...
            var orig = new GenericFieldByte0();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldByte0.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldByte0)data;
        ...
        public static uint Serialize(GenericFieldByte0 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldByte0 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldByte0.numberMask;
            }
