...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUShort4 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUShort4.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUShort4 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 127");
            }
            ...
            var orig = new GenericFieldUShort4();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUShort4.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldUShort4)data;
        ...
        public static uint Serialize(GenericFieldUShort4 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldUShort4 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldUShort4();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUShort4.numberMask;
            }
