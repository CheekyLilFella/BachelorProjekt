...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUShort2 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUShort2.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUShort2 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 125");
            }
            ...
            var orig = new GenericFieldUShort2();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUShort2.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldUShort2)data;
        ...
        public static uint Serialize(GenericFieldUShort2 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldUShort2 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldUShort2();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUShort2.numberMask;
            }
