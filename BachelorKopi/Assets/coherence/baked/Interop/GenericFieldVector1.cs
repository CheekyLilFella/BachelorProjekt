...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldVector1 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldVector1.valueMask;
            valueSimulationFrame = frame;
        }

        public static unsafe GenericFieldVector1 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 12) {
            ...
            var orig = new GenericFieldVector1();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldVector1.valueMask) != 0 && (min == null || this.valueSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldVector1 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldVector1 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldVector1.valueMask;
            }
