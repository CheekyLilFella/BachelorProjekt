...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldSByte8 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldSByte8.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldSByte8 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 111");
            }
            ...
            var orig = new GenericFieldSByte8();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldSByte8.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldSByte8)data;
        ...
        public static uint Serialize(GenericFieldSByte8 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldSByte8 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldSByte8();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldSByte8.numberMask;
            }
