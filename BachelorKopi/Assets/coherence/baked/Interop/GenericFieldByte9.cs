...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldByte9 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldByte9.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldByte9 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 102");
            }
            ...
            var orig = new GenericFieldByte9();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldByte9.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldByte9)data;
        ...
        public static uint Serialize(GenericFieldByte9 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldByte9 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldByte9.numberMask;
            }
