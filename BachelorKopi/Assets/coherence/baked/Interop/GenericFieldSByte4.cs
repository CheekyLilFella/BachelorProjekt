...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldSByte4 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldSByte4.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldSByte4 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 107");
            }
            ...
            var orig = new GenericFieldSByte4();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldSByte4.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldSByte4)data;
        ...
        public static uint Serialize(GenericFieldSByte4 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldSByte4 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldSByte4();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldSByte4.numberMask;
            }
