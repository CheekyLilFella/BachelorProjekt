...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldSByte5 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldSByte5.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldSByte5 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 108");
            }
            ...
            var orig = new GenericFieldSByte5();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldSByte5.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldSByte5)data;
        ...
        public static uint Serialize(GenericFieldSByte5 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldSByte5 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldSByte5();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldSByte5.numberMask;
            }
