...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldDouble7 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldDouble7.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldDouble7 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
            ...
            var orig = new GenericFieldDouble7();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldDouble7.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldDouble7)data;
        ...
        public static uint Serialize(GenericFieldDouble7 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldDouble7 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldDouble7();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldDouble7.numberMask;
            }
