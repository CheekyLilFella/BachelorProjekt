...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldString3 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldString3.nameMask;
            nameSimulationFrame = frame;
        }

        public static unsafe GenericFieldString3 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 16) " +
                    "for component with ID 79");
            }
            ...
            var orig = new GenericFieldString3();
        ...
        public static uint nameMask => 0b00000000000000000000000000000001;
        public AbsoluteSimulationFrame nameSimulationFrame;
        ...
        public long[] GetSimulationFrames() {
            ...
            simulationFrames[0] = nameSimulationFrame;
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldString3.nameMask) != 0 && (min == null || this.nameSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldString3 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                if (isRefSimFrameValid) {
                    var simFrameDelta = data.nameSimulationFrame - referenceSimulationFrame;
        ...
        public static GenericFieldString3 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldString3.nameMask;
            }
