...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldVector2 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldVector2.valueMask;
            valueSimulationFrame = frame;
        }

        public static unsafe GenericFieldVector2 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 12) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 12) " +
                    "for component with ID 70");
            }
            ...
            var orig = new GenericFieldVector2();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldVector2.valueMask) != 0 && (min == null || this.valueSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldVector2 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldVector2 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldVector2.valueMask;
            }
