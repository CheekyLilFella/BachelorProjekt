...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldDouble3 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldDouble3.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldDouble3 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
            ...
            var orig = new GenericFieldDouble3();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldDouble3.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldDouble3)data;
        ...
        public static uint Serialize(GenericFieldDouble3 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldDouble3 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldDouble3();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldDouble3.numberMask;
            }
