...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldString4 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldString4.nameMask;
            nameSimulationFrame = frame;
        }

        public static unsafe GenericFieldString4 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 16) " +
                    "for component with ID 80");
            }
            ...
            var orig = new GenericFieldString4();
        ...
        public static uint Serialize(GenericFieldString4 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldString4 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
