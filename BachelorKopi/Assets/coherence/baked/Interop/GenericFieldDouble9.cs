...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldDouble9 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldDouble9.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldDouble9 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 8) " +
                    "for component with ID 67");
            }
            ...
            var orig = new GenericFieldDouble9();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldDouble9.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldDouble9)data;
        ...
        public static uint Serialize(GenericFieldDouble9 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldDouble9 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldDouble9();
            if (bitStream.ReadMask())
            {
                val.numberSimulationFrame = referenceSimulationFrame + DeserializerTools.ReadFieldSimFrameDelta(bitStream);

                val.number = bitStream.ReadDouble();
                val.FieldsMask |= GenericFieldDouble9.numberMask;
            }
