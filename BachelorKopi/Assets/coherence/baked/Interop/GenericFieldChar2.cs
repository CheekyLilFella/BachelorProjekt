...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldChar2 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldChar2.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldChar2 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 135");
            }
            ...
            var orig = new GenericFieldChar2();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldChar2.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldChar2)data;
        ...
        public static uint Serialize(GenericFieldChar2 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldChar2 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldChar2.numberMask;
            }
