...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldInt6 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldInt6.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldInt6 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldInt6.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldInt6 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.number, _number_Min, _number_Max, "GenericFieldInt6.number", logger);
        ...
        public static GenericFieldInt6 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldInt6.numberMask;
            }
