...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldChar6 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldChar6.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldChar6 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 139");
            }
            ...
            var orig = new GenericFieldChar6();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldChar6.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldChar6)data;
        ...
        public static uint Serialize(GenericFieldChar6 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldChar6 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldChar6.numberMask;
            }
