...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldByte1 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldByte1.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldByte1 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 94");
            }
            ...
            var orig = new GenericFieldByte1();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldByte1.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldByte1)data;
        ...
        public static uint Serialize(GenericFieldByte1 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldByte1 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldByte1.numberMask;
            }
