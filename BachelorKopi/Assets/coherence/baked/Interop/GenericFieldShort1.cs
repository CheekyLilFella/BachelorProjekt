...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldShort1 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldShort1.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldShort1 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 114");
            }
            ...
            var orig = new GenericFieldShort1();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldShort1.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldShort1)data;
        ...
        public static uint Serialize(GenericFieldShort1 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldShort1 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldShort1();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldShort1.numberMask;
            }
