...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUInt5 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUInt5.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUInt5 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
            ...
            var orig = new GenericFieldUInt5();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUInt5.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldUInt5 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                ...
                Coherence.Utils.Bounds.Check(data.number, _number_Min, _number_Max, "GenericFieldUInt5.number", logger);
        ...
        public static GenericFieldUInt5 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUInt5.numberMask;
            }
