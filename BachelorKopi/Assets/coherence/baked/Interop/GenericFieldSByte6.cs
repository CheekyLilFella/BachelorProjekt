...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldSByte6 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldSByte6.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldSByte6 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 1) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 1) " +
                    "for component with ID 109");
            }
            ...
            var orig = new GenericFieldSByte6();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldSByte6.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldSByte6)data;
        ...
        public static uint Serialize(GenericFieldSByte6 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldSByte6 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldSByte6();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldSByte6.numberMask;
            }
