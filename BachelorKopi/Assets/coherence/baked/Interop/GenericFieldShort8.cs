...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldShort8 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldShort8.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldShort8 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 121");
            }
            ...
            var orig = new GenericFieldShort8();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldShort8.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldShort8)data;
        ...
        public static uint Serialize(GenericFieldShort8 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldShort8 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldShort8();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldShort8.numberMask;
            }
