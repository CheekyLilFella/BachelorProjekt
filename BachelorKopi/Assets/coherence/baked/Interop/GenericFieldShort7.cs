...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldShort7 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldShort7.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldShort7 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 120");
            }
            ...
            var orig = new GenericFieldShort7();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldShort7.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldShort7)data;
        ...
        public static uint Serialize(GenericFieldShort7 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldShort7 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldShort7();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldShort7.numberMask;
            }
