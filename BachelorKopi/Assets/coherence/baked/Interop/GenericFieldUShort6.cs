...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUShort6 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUShort6.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUShort6 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 129");
            }
            ...
            var orig = new GenericFieldUShort6();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUShort6.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldUShort6)data;
        ...
        public static uint Serialize(GenericFieldUShort6 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldUShort6 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldUShort6();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUShort6.numberMask;
            }
