...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldString0 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldString0.nameMask;
            nameSimulationFrame = frame;
        }

        public static unsafe GenericFieldString0 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 16) " +
                    "for component with ID 76");
            }
            ...
            var orig = new GenericFieldString0();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldString0.nameMask) != 0 && (min == null || this.nameSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldString0 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldString0 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldString0.nameMask;
            }
