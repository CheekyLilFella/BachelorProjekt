...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUShort5 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUShort5.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUShort5 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 128");
            }
            ...
            var orig = new GenericFieldUShort5();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUShort5.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldUShort5)data;
        ...
        public static uint Serialize(GenericFieldUShort5 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldUShort5 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldUShort5();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUShort5.numberMask;
            }
