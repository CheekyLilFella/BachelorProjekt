...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldShort0 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldShort0.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldShort0 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 113");
            }
            ...
            var orig = new GenericFieldShort0();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldShort0.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldShort0)data;
        ...
        public static uint Serialize(GenericFieldShort0 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldShort0 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldShort0();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldShort0.numberMask;
            }
