...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldEntity6 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldEntity6.valueMask;
            valueSimulationFrame = frame;
        }

        public static unsafe GenericFieldEntity6 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for component with ID 88");
            }
            ...
            var orig = new GenericFieldEntity6();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldEntity6.valueMask) != 0 && (min == null || this.valueSimulationFrame < min))
            {
        ...
        public static uint Serialize(GenericFieldEntity6 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldEntity6 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldEntity6.valueMask;
            }
