...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUShort9 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUShort9.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUShort9 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 132");
            }
            ...
            var orig = new GenericFieldUShort9();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUShort9.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldUShort9)data;
        ...
        public static uint Serialize(GenericFieldUShort9 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldUShort9 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldUShort9();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUShort9.numberMask;
            }
