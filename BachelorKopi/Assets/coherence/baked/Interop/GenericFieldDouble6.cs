...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldDouble6 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldDouble6.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldDouble6 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
            ...
            var orig = new GenericFieldDouble6();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldDouble6.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldDouble6)data;
        ...
        public static uint Serialize(GenericFieldDouble6 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldDouble6 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldDouble6();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldDouble6.numberMask;
            }
