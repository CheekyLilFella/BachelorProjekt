...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldShort4 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldShort4.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldShort4 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 117");
            }
            ...
            var orig = new GenericFieldShort4();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldShort4.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldShort4)data;
        ...
        public static uint Serialize(GenericFieldShort4 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldShort4 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldShort4();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldShort4.numberMask;
            }
