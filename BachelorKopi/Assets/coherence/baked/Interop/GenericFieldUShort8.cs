...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldUShort8 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldUShort8.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldUShort8 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 131");
            }
            ...
            var orig = new GenericFieldUShort8();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldUShort8.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldUShort8)data;
        ...
        public static uint Serialize(GenericFieldUShort8 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldUShort8 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldUShort8();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldUShort8.numberMask;
            }
