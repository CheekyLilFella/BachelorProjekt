...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldShort6 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldShort6.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldShort6 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 2) {
                throw new Exception($"Given data size is not equal to the struct size. ({dataSize} != 2) " +
                    "for component with ID 119");
            }
            ...
            var orig = new GenericFieldShort6();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldShort6.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldShort6)data;
        ...
        public static uint Serialize(GenericFieldShort6 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldShort6 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldShort6();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldShort6.numberMask;
            }
