...
namespace Coherence.Generated
{
    ...
    public struct GenericFieldDouble5 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= GenericFieldDouble5.numberMask;
            numberSimulationFrame = frame;
        }

        public static unsafe GenericFieldDouble5 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 8) {
            ...
            var orig = new GenericFieldDouble5();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & GenericFieldDouble5.numberMask) != 0 && (min == null || this.numberSimulationFrame < min))
            {
        ...
        {
            var other = (GenericFieldDouble5)data;
        ...
        public static uint Serialize(GenericFieldDouble5 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static GenericFieldDouble5 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new GenericFieldDouble5();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= GenericFieldDouble5.numberMask;
            }
