...
public class IceSpike : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            gameObject.GetComponent<Rigidbody>().AddForce(-transform.position * reverseIceSpeed, ForceMode.Impulse);
        }
