...
namespace Coherence.Cloud
{
    ...
    /// <summary>
    /// <see cref="CloudStorage"/> is a service that allows you to save and load objects to and from the backend.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// one second, except in rare circumstances where the same objects are being targeted by a combination of both
