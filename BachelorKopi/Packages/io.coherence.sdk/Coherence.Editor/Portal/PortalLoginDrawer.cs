...
namespace Coherence.Editor.Portal
{
    ...
    internal class PortalLoginDrawer
    {
        ...
        public static float DrawOrganizationOptions()
        {
            ...
            {
                var projectsPopup =
                    new PopupPicker<Organization>(organizations, MaxPickListRows, controlRect.width, item => item.name);
        ...
        public static void DrawProjectOptions(float labelWidth)
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                {
                    var projectsPopup =
                        new PopupPicker<ProjectInfo>(projects, MaxPickListRows, controlRect.width, item => item.name);
